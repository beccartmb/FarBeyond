...
public class HeartsCode : MonoBehaviour
{
    ...
    {
        if(GameManager.Instance.currentSave.playerLife>=4)
        {
        ...
        else if(GameManager.Instance.currentSave.playerLife==3)
        {
        ...
        else if (GameManager.Instance.currentSave.playerLife == 2)
        {
        ...
        else if (GameManager.Instance.currentSave.playerLife == 1)
        {
        ...
        else if (GameManager.Instance.currentSave.playerLife <= 0)
        {
